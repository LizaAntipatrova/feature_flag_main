...
public enum Role {
    ...
    ROLE_AUTH_SERVICE(Role.ROLE_AUTH_SERVICE_NAME),
    ROLE_SDK_CLIENT(Role.ROLE_SDK_CLIENT_NAME);
    ...
    public static final String ROLE_AUTH_SERVICE_NAME = "auth_service";
    public static final String ROLE_SDK_CLIENT_NAME = "sdk_client";
